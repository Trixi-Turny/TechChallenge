...
*The app is running, but not all functionalities are implemented, Only the first part of the story is loaded on the start. The logic around looping through the rest of the data has not been added.
*The code could be more organised and more scaleable.
