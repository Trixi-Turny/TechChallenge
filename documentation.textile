...
*Research into Tree Structures and the logic around them

h5.Shortcuts and Implications

p.Some shortcuts have been made for the following reasons:

*The right information took too long to find/wasn't available
*The online courses were mostly useful, but often the required piece of information was not included, sometimes the wrong path was followed, which later on caused errors not easily recognised.
...
*The app is running and functional, but the time to implement the solution had to be extended.
...
*Understanding the logic and simplicity of get/Post Requests
*Understanding Tree Structures and URL manipulation/mapping
